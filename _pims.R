...
### Преобразование данных wide-to-long, где строка - это данные о событии в игре для каждого из пяти игроков команды, в которой играет переменная player
...
### Разделение на четыре вектора по парам (координата, on_off)
